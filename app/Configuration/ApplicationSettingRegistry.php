    ...
    public function all(): array
    {
        ...
        $definitions = [
            ...
            new ApplicationSettingDefinition(
                ...
                helpText: 'Autorise uniquement les contrôles de diagnostic; DrClickDz ne désactive jamais le pare-feu.',
                type: ApplicationSettingType::BOOLEAN,
                defaultValue: true,
                scope: 'installation',
                backupPolicy: 'machine_bound',
            ...
            new ApplicationSettingDefinition(
                ...
                helpText: 'Demande au shell desktop de démarrer DrClickDz avec Windows.',
                type: ApplicationSettingType::BOOLEAN,
                defaultValue: false,
                scope: 'installation',
                restart: 'desktop',
