...
class SecurityController extends Controller
{
    ...
    public function edit(
        ...
        $idleLock = $settings->describe(ApplicationSettingRegistry::SECURITY_IDLE_LOCK_MINUTES);
        $props = [
            ...
            'idleLock' => [
                ...
                'maximum' => (int) $idleLock['maximum'],
                'canManage' => $request->user()->can(PermissionName::SETTINGS_MANAGE->value),
            ],
        ];
