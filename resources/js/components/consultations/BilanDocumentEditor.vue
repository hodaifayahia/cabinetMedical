...
const insertTable = () => {
    execute(
        'insertHTML',
        '<table style="width:100%;border-collapse:collapse"><tbody><tr><td style="border:1px solid #333;padding:6px">Examen</td><td style="border:1px solid #333;padding:6px">Résultat</td></tr><tr><td style="border:1px solid #333;padding:6px"> </td><td style="border:1px solid #333;padding:6px"> </td></tr></tbody></table><p><br></p>',
    );
};
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <option value="document.date">Bilan · Date</option>
                </select>
                <span class="mx-1 h-5 w-px bg-border" />
                <Button
                    variant="ghost"
        ...
        >
            ...
            >
                ...
                <div class="relative mt-7">
                    ...
                    <div
                        v-if="items.length"
                        class="relative mt-4 space-y-3 pl-2"
                    >
                        <div
                    ...
                    <p v-else class="relative mt-4 text-slate-400">
                        Sélectionnez un examen à gauche pour le voir apparaître
                        ici.
                    </p>
                    <p
                        v-if="notes"
