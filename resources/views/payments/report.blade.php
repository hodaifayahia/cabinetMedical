...
<head>
    ...
    <style nonce="{{ Vite::cspNonce() }}">
        * { box-sizing: border-box; }
        ...
        .title { margin: 28px 0 14px; padding: 14px; background: #e7f5f1; text-align: center; font-size: 22px; font-weight: 800; }
        table { width: 100%; border-collapse: collapse; font-size: 12px; }
        th, td { border: 1px solid #9ca9b5; padding: 9px 8px; vertical-align: top; }
        th { background: #eef8f5; font-weight: 800; text-transform: uppercase; }
